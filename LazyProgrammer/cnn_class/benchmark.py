...
def get_data():
    if not os.path.exists('data_files/train_32x32.mat'):
        print('Looking for data_files/train_32x32.mat')
    ...
    train = loadmat('data_files/train_32x32.mat')
    test  = loadmat('data_files/test_32x32.mat')
    return train, test
